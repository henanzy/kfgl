	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<!-- 		<span style="font-size:20px;margin-left:20px;"> | </span>
					<span>选择公司：
         <select id="ssgs" style="width:100px" name="ssgs">
         </select>
         </span> -->
					<!-- <select id="xjgd">
		...
		<div id="increase_word">
           ...
           <div class="layui-input-inline" style="width:200px;">
               <select style="width:200px"  id="xqName" name="xqName" class="layui-input-inline">
      ...
      <!--  </div> -->
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<!-- <input type="text" class="mws-textinput increase_word_input"
										name="buildNo" value="" /> -->
										<div class="layui-input-inline" style="width:200px;">
              	 <select style="width:200px"  id="buildNo" name="buildNo" class="layui-input-inline">
                	<option value="">--请选择楼栋--</option>
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
							<div class="layui-input-inline" style="width:200px;">
              	  <select style="width:200px"  id="cellNo" name="cellNo"  class="layui-input-inline">
				...
				<div class="mws-form-row">
								...
								<div class="mws-form-item large">
							<div class="layui-input-inline" style="width:200px;">
              	  <select style="width:200px"  id="houseNo" name="houseNo"  class="layui-input-inline">
                	<option>--请选择户号--</option>
                	</select>
          		          </div>
								</div>
...
$.ajax({
    type: "post",
    url: "<%=basePath%>KfgdCon/searGdxx.action",
    dataType: "json",
    data : {
			"state" : "",
			"tjName" : "",
