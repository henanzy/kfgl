...
<body>
	...
	<div id="" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			style="width: 98%;padding-left:14px; margin: 0px 0px 30px 0px; min-width:1000px">
			<div class="mws-panel-header">
         ...
         <select id="ssgs" style="width:150px" name="ssgs">
					...
					<span class="call_time">开始时间：<input type="date" name="start_time" id="start_timeTel" value="2019-02-16" /> — 结束时间：<input type="date" name="end_time" id="end_timeTel" value="" max="" /></span>
		...
		<div class="mws-panel grid_8 "
			style="width: 98%; padding-left: 12px; margin: 0px 0px 30px 0px; min-width:100px">
			<div class="mws-panel-header">
			...
			<div class="word-search">
				<p>
				<span>选择公司：
         <select id="sgs" style="width:150px" name="ssgs">
         </select>
         </span>
					<span class="word_time">开始时间：<input type="date" name="start_word_time" id="start_word_time" value="2019-02-16" /> — 结束时间：<input type="date" name="end_word_time" id="end_word_time" value="" max="" /></span>
			...
			<div id="xincreate_table_body" class="mws-panel-body"
				style="overflow: auto !important;white-space: nowrap; height: 500px;width:100%;">
...
{ 
	var s=strs[i];
	 ...
	 $("#sgs").append("<option value='"+s+"'>"+s+"</option>");
} 
/* 
if(ssgs!="null"){
