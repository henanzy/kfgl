...
<script type="text/javascript" >
$.ajax({
	url:"<%=basePath%>KfgdCon/selCsb.action",
...
function cstj(){
	$.ajax({
			url:"<%=basePath%>KfgdCon/insertCs.action",
			async:false,
			dataType:"json",
			data:{	
				"sj":$('#overdueID').val(),
	...
	<div id="" class="clearfix" style="overflow-x: hidden;">
		...
		<p class="mws-report" href="#" style="font-size: 14px;">
				...
				<span class="mws-report-content" style="margin-top: 10px;"> 
					<span class="mws-report-title"> 逾期时间标准
						<select id="overdueID" name="overdue">
							...
							<input type="submit" id="cstj" onclick="cstj()" class="mws-button black" value="提交" />
