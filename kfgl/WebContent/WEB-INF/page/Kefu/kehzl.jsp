...
<body>
	...
	<div id="" class="clearfix" style="overflow-x: hidden; height: 100%;">
		...
		<div  style="background-image: url(../images/background/2.jpg)  no-repeat center 104px 105px;width:100%;background-color: red;">
		...
		<!-- <div  style="background-image: url(../images/background/2.jpg)  no-repeat center 104px 105px;width:100%;hight:100%;background-color: red;">
		dddd
		</div> -->
						...
						<div class="mws-form-inline">
							<div class="mws-form-row" style="height:14px;">
								...
								<div class="mws-form-item large">
									<input type="text" id="yhName" class="mws-textinput user_input" value=""
										readonly="readonly" />
								</div>
							</div>
