...
public interface KfgdDao {
	...
	public List<Kfgd> searGdxx(@Param("state")String state,@Param("tjName")String tjName);
	public List<Kfgd> searGdlx(@Param("state")String state,@Param("tjName")String tjName);
	//遍历登记人
