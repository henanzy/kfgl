...
public class KfgdServiceImpl implements KfgdService{
	...
	@Override
	public List<Kfgd> searGdxx(String state, String tjName) {
		// TODO Auto-generated method stub
		return kfgdDao.searGdxx(state, tjName);
	}
	@Override
	public List<Kfgd> searGdlx(String state, String tjName) {
		// TODO Auto-generated method stub
		return kfgdDao.searGdlx(state, tjName);
	}
	@Override
	public List<Kfgd> selectTjName() {
		// TODO Auto-generated method stub
		return kfgdDao.selectTjName();
	}
	@Override
	public List<Kfgd> selectGd(Kfgd kfgd) {
		// TODO Auto-generated method stub
		return kfgdDao.selectGd(kfgd);
	}
}
